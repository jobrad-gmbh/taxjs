System.register(["big.js"], function (exports_1, context_1) {
    "use strict";
    var big_js_1, Lohnsteuer2025Big;
    ...
    return {
        ...
        execute: function () {
            Lohnsteuer2025Big = /** @class */ (function () {
                /**
                ...
                */
                ...
                Lohnsteuer2025Big.prototype.MPARA = function () {
                    ...
                    this.BBGKVPV = new big_js_1.default(66150);
                    /**   Geändert für 2025   */
                    this.KVSATZAN = (this.KVZ.div(this.ZAHL2).div(this.ZAHL100)).add(new big_js_1.default(0.07));
                    this.KVSATZAG = new big_js_1.default(0.0125).add(new big_js_1.default(0.07));
                    /**   geändert für 2025   */
                    if (this.PVS == 1) {
                        this.PVSATZAN = new big_js_1.default(0.023);
                        /**   geändert für 2025   */
                        this.PVSATZAG = new big_js_1.default(0.013);
                        /**   geändert für 2025   */
                    }
                    else {
                        this.PVSATZAN = new big_js_1.default(0.018);
                        this.PVSATZAG = new big_js_1.default(0.018);
                        /**   geändert für 2025   */
                    }
                    if (this.PVZ == 1) {
                    ...
                    this.W1STKL5 = new big_js_1.default(13785);
                    /**   geändert für 2025   */
                    this.W2STKL5 = new big_js_1.default(34240);
                    /**   geändert für 2025   */
                    this.W3STKL5 = new big_js_1.default(222260);
                    this.GFB = new big_js_1.default(12096);
                    /**   geändert für 2025   */
                    this.SOLZFREI = new big_js_1.default(19950);
                    /**   geändert für 2025   */
                };
                ...
                Lohnsteuer2025Big.prototype.MZTABFB = function () {
                    ...
                    if (this.STKL == 1) {
                        ...
                        this.KFB = (this.ZKF.mul(new big_js_1.default(9600))).round(0, big_js_1.default.roundDown);
                        /**   geändert für 2025   */
                    }
                    else {
                        if (this.STKL == 2) {
                            ...
                            if (this.STKL == 3) {
                                ...
                                if (this.STKL == 4) {
                                    this.SAP = new big_js_1.default(36);
                                    this.KFB = (this.ZKF.mul(new big_js_1.default(4800))).round(0, big_js_1.default.roundDown);
                                    /**   geändert für 2025   */
                                }
                                else {
                                    if (this.STKL == 5) {
                ...
                Lohnsteuer2025Big.prototype.UPTAB25 = function () {
                    ...
                    if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
                        ...
                        if (this.X.cmp(new big_js_1.default(17444)) == -1) {
                            /**   geändert für 2025   */
                            this.Y = (this.X.sub(this.GFB)).div(this.ZAHL10000).round(6, big_js_1.default.roundDown);
                            this.RW = this.Y.mul(new big_js_1.default(932.30));
                            /**   geändert für 2025   */
                            this.RW = this.RW.add(new big_js_1.default(1400));
                            this.ST = (this.RW.mul(this.Y)).round(0, big_js_1.default.roundDown);
                        }
                        else {
                            if (this.X.cmp(new big_js_1.default(68481)) == -1) {
                                /**   geändert für 2025   */
                                this.Y = (this.X.sub(new big_js_1.default(17443))).div(this.ZAHL10000).round(6, big_js_1.default.roundDown);
                                /**   geändert für 2025   */
                                this.RW = this.Y.mul(new big_js_1.default(176.64));
                                /**   geändert für 2025   */
                                this.RW = this.RW.add(new big_js_1.default(2397));
                                this.RW = this.RW.mul(this.Y);
                                this.ST = (this.RW.add(new big_js_1.default(1015.13))).round(0, big_js_1.default.roundDown);
                                /**   geändert für 2025   */
                            }
                            else {
                                if (this.X.cmp(new big_js_1.default(277826)) == -1) {
                                    this.ST = ((this.X.mul(new big_js_1.default(0.42))).sub(new big_js_1.default(10911.92))).round(0, big_js_1.default.roundDown);
                                    /**   geändert für 2025   */
                                }
                                else {
                                    this.ST = ((this.X.mul(new big_js_1.default(0.45))).sub(new big_js_1.default(19246.67))).round(0, big_js_1.default.roundDown);
                                    /**   geändert für 2025   */
                                }
                            }
                        }
            ...
            exports_1("Lohnsteuer2025Big", Lohnsteuer2025Big);
        }
    };
});
