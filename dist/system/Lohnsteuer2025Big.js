            ...
            Lohnsteuer2025Big = /** @class */ (function () {
                ...
                */
                ...
                Lohnsteuer2025Big.prototype.MPARA = function () {
                    ...
                    this.W1STKL5 = new big_js_1.default(13432); /**  geändert für 2025  */
                    this.W2STKL5 = new big_js_1.default(33380); /**  geändert für 2025  */
                    this.W3STKL5 = new big_js_1.default(222260);
                    this.GFB = new big_js_1.default(11784);
                    this.SOLZFREI = new big_js_1.default(18130);
                };
                ...
                Lohnsteuer2025Big.prototype.MZTABFB = function () {
                    ...
                    if (this.STKL == 1) {
                        ...
                        this.KFB = (this.ZKF.mul(new big_js_1.default(9540))).round(0, big_js_1.default.roundDown); /**  geändert für 2025  */
                    }
                    else {
                        if (this.STKL == 2) {
                            ...
                            if (this.STKL == 3) {
                                ...
                                if (this.STKL == 4) {
                                    this.SAP = new big_js_1.default(36);
                                    this.KFB = (this.ZKF.mul(new big_js_1.default(4770))).round(0, big_js_1.default.roundDown); /**  geändert für 2025  */
                                }
                                else {
                                    if (this.STKL == 5) {
                                        this.SAP = new big_js_1.default(36);
                ...
                Lohnsteuer2025Big.prototype.UPTAB24 = function () {
                    if (this.X.cmp(this.GFB.add(this.ZAHL1)) == -1) {
                        this.ST = this.Z_0;
                    }
                    else {
                        if (this.X.cmp(new big_js_1.default(17006)) == -1) {
                            this.Y = (this.X.sub(this.GFB)).div(this.ZAHL10000).round(6, big_js_1.default.roundDown);
                            this.RW = this.Y.mul(new big_js_1.default(954.8));
                            this.RW = this.RW.add(new big_js_1.default(1400));
                            this.ST = (this.RW.mul(this.Y)).round(0, big_js_1.default.roundDown);
                        }
                        else {
                            if (this.X.cmp(new big_js_1.default(66761)) == -1) {
                                this.Y = (this.X.sub(new big_js_1.default(17005))).div(this.ZAHL10000).round(6, big_js_1.default.roundDown);
                                this.RW = this.Y.mul(new big_js_1.default(181.19));
                                this.RW = this.RW.add(new big_js_1.default(2397));
                                this.RW = this.RW.mul(this.Y);
                                this.ST = (this.RW.add(new big_js_1.default(991.21))).round(0, big_js_1.default.roundDown);
                            }
                            else {
                                if (this.X.cmp(new big_js_1.default(277826)) == -1) {
                                    this.ST = ((this.X.mul(new big_js_1.default(0.42))).sub(new big_js_1.default(10636.31))).round(0, big_js_1.default.roundDown);
                                }
                                else {
                                    this.ST = ((this.X.mul(new big_js_1.default(0.45))).sub(new big_js_1.default(18971.06))).round(0, big_js_1.default.roundDown);
                                }
                            }
                        }
                    }
