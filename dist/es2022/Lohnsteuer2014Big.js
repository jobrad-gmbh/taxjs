...
export class Lohnsteuer2014Big {
    ...
    /**  Für den Lohnzahlungszeitraum berücksichtigte Beiträge des Arbeitnehmers zur
         ...
         VKVSONST  */
    VKVLZZ = this.Z_0; /**  Neu 2014 Ursprünglich INTERNAL definiert  */
    ...
    VKVSONST = this.Z_0; /** Neu 2014 Ursprünglich INTERNAL definiert  */
    /**   INTERNE FELDER   */
    ...
    /**  Neuer Wert  2014  */
    RENTBEMESSUNGSGR_OST = new Big(60000);
    /**  Rentenbemessungs-Grenze alte Bundesländer in EUR  */
    /**  Neuer Wert 2014  */
    RENTBEMESSUNGSGR_WEST = new Big(71400);
